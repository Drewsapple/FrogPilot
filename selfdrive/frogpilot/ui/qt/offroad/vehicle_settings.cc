...
FrogPilotVehiclesPanel::FrogPilotVehiclesPanel(FrogPilotSettingsWindow *parent) : FrogPilotListWidget(parent), parent(parent) {
  ...
  std::set<QString> rebootKeys = {"CrosstrekTorque", "ExperimentalGMTune", "FrogsGoMoosTweak", "HyundaiRadarTracks", "NewLongAPI", "NewLongAPIGM"};
...
void FrogPilotVehiclesPanel::updateToggles() {
  ...
  toggles["HyundaiRadarTracks"]->setVisible(toggles["HyundaiRadarTracks"]->isVisible() && customizationLevel == 2);
